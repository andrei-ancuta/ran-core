 ...
 */
@Component
public class RaportSchemaGen {
    public String generateListaRapoarteXsdSchema() throws JAXBException, IOException {
        return generateXsdSchema(RapoarteSummary.class);
    }
