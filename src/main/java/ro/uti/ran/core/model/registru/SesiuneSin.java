...
public class SesiuneSin implements Serializable {

    @Id
    @GeneratedValue(generator = "SesiuneSinSeq", strategy = GenerationType.SEQUENCE)
    @SequenceGenerator(name = "SesiuneSinSeq", sequenceName = "SEQ_APP_SESIUNE", allocationSize = 1)
    ...
    @Transient
    private UtilizatorSin utilizatorSin;
...
//    private Context context;
    ...
    public UtilizatorSin getUtilizatorSin() {
        return utilizatorSin;
    }

    public void setUtilizatorSin(UtilizatorSin utilizatorSin) {
        this.utilizatorSin = utilizatorSin;
    }
