 ...
 */
@Entity
@Table(name = "NOM_STARE_REGISTRU_CORE")
@NamedQuery(name = "NomStareRegistru.findAll", query = "SELECT n FROM NomStareRegistru n")
public class NomStareRegistruCore extends Nomenclator {
    private static final long serialVersionUID = 1L;

    @Id
    @SequenceGenerator(name = "NOM_STARE_REGISTRU_CORE_ID_GENERATOR", sequenceName = "SEQ_NOM_STARE_REGISTRU", allocationSize = 1)
