...
/**
 * The persistent class for the CAP_SISTEM_TEHNIC database table.
 */
@Entity
@Table(name = "CAP_SISTEM_TEHNIC")
@NamedQuery(name = "CapSistemTehnic.findAll", query = "SELECT c FROM CapSistemTehnic c")
public class CapSistemTehnic extends Nomenclator implements Serializable, Editable, Versioned, NomCapRegistrulAgricol {
    private static final long serialVersionUID = 1L;

    @Id
    @SequenceGenerator(name = "CAP_SISTEM_TEHNIC_IDCAP_SISTEM_TEHNIC_GENERATOR", sequenceName = "SEQ_CAP_SISTEM_TEHNIC", allocationSize = 1)
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "CAP_SISTEM_TEHNIC_IDCAP_SISTEM_TEHNIC_GENERATOR")
    @Column(name = "ID_CAP_SISTEM_TEHNIC")
    private Long id;
