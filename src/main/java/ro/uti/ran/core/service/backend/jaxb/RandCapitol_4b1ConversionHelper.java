 ...
 */
public class RandCapitol_4b1ConversionHelper {
    /**
     ...
     * @return jaxb pojo
     */
    public static SectiuneCapitol_4b1 toSchemaType(Cultura cultura) {
        if (cultura == null) {
            throw new IllegalArgumentException("Cultura nedefinit!");
        }
        SectiuneCapitol_4b1 sectiuneCapitol_4B1 = new SectiuneCapitol_4b1();
        /*codNomenclator + codRand + denumire*/
        if (cultura.getCapCultura() != null) {
            sectiuneCapitol_4B1.setCodNomenclator(cultura.getCapCultura().getCod());
            sectiuneCapitol_4B1.setCodRand(cultura.getCapCultura().getCodRand());
            sectiuneCapitol_4B1.setDenumire(cultura.getCapCultura().getDenumire());
        }
        /*nrMP*/
        if (cultura.getSuprafata() != null) {
            INTREG_POZITIV intreg_pozitiv = new INTREG_POZITIV();
            intreg_pozitiv.setValue(cultura.getSuprafata());
            sectiuneCapitol_4B1.setNrMP(intreg_pozitiv);
        }
        /*referintaGeoXml*/
        if (cultura.getGeometrieCulturi() != null) {
            ...
            sectiuneCapitol_4B1.setGeometrieCultura(geometrie);
        }
        return sectiuneCapitol_4B1;
    }
     ...
     *
     * @param sectiuneCapitol_4B1 jaxb pojo
     * @param gospodarie          entity pojo
     */
    public static void populeazaFromSchemaType(SectiuneCapitol_4b1 sectiuneCapitol_4B1, Gospodarie gospodarie, Integer anRaportare) {
        if (sectiuneCapitol_4B1 == null) {
            throw new IllegalArgumentException("RandCapitol_4b1 nedefinit!");
        }
        if (gospodarie == null) {
        ...
        capCultura.setCod(sectiuneCapitol_4B1.getCodNomenclator());
        capCultura.setCodRand(sectiuneCapitol_4B1.getCodRand());
        capCultura.setDenumire(sectiuneCapitol_4B1.getDenumire());
        //
        cultura.setCapCultura(capCultura);
        /*nrMP*/
        if (sectiuneCapitol_4B1.getNrMP() != null) {
            cultura.setSuprafata(sectiuneCapitol_4B1.getNrMP().getValue());
        }
        /*NOM_TIP_SPATIU_PROT*/
        NomTipSpatiuProt nomTipSpatiuProt = new NomTipSpatiuProt();
        nomTipSpatiuProt.setCod(RanConstants.NOM_TIP_SPATIU_PROT_COD_SERA);
        //
        cultura.setNomTipSpatiuProt(nomTipSpatiuProt);
        /*referintaGeoXml*/
        List<GeometrieCultura> listaGeo = new ArrayList<GeometrieCultura>();
        List<GEOMETRIE_CULTURA> geoInfo = sectiuneCapitol_4B1.getGeometrieCultura();
        if (geoInfo != null) {
